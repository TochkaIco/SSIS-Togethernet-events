...
class User extends Authenticatable
{
    ...
    public function validClasses(): array
    {
        return [
            'Personal',
            'Alumni',
            'TE'.now()->subMonths(6)->addDays(12)->format('y').'A',
            'TE'.now()->subMonths(6)->addDays(12)->format('y').'B',
            'TE'.now()->subMonths(6)->addDays(12)->format('y').'C',
            'TE'.now()->subMonths(6)->addDays(12)->format('y').'D',
            'TE'.now()->subMonths(6)->addDays(12)->subYear()->format('y').'A',
            'TE'.now()->subMonths(6)->addDays(12)->subYear()->format('y').'B',
            'TE'.now()->subMonths(6)->addDays(12)->subYear()->format('y').'C',
            'TE'.now()->subMonths(6)->addDays(12)->subYear()->format('y').'D',
            'TE'.now()->subMonths(6)->addDays(12)->subYears(2)->format('y').'A',
            'TE'.now()->subMonths(6)->addDays(12)->subYears(2)->format('y').'B',
            'TE'.now()->subMonths(6)->addDays(12)->subYears(2)->format('y').'C',
            'TE'.now()->subMonths(6)->addDays(12)->subYears(2)->format('y').'D',
        ];
    }
