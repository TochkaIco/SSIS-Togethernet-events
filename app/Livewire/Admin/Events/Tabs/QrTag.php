...
class QrTag extends Component
{
    ...
    public function respawnPlayer(int $registrationId): void
    {
        ...
        $registration->update([
            ...
            'qr_tag_token' => Str::substr($registration->user->email, 0, 4).Str::random(28),
        ]);
    ...
    public function render()
    {
        ...
        return view('livewire.admin.events.tabs.qr-tag', [
            ...
            'allClassGroups' => [
                'Personal',
                'Alumni',
                'TE'.now()->subMonths(6)->addDays(20)->format('y'),
                'TE'.now()->subMonths(6)->addDays(20)->subYear()->format('y'),
                'TE'.now()->subMonths(6)->addDays(20)->subYears(2)->format('y'),
            ],
        ]);
    }
}
