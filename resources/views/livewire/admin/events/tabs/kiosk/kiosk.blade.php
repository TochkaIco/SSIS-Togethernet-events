                ...
                @else
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        @foreach($articles as $article)
                            <div class="relative border-2 border-accent-content/5 rounded-lg p-4 h-44 flex flex-col justify-between overflow-hidden group transition-all duration-300 shadow-lg hover:-translate-y-1 hover:shadow-2xl">
